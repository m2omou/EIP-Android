...
public class ViewMemory extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
        ...
        viewLink = (TextView)findViewById(R.id.commBtnLink);
	...
	//	editPost = (EditText)findViewById(R.id.postEditCommentary);
        ...
        //Toast.makeText(getApplicationContext(), "Pour : " + memory.type + " jai " + memory.url , Toast.LENGTH_SHORT).show();
        if (memory.type == 0) {
            //Toast.makeText(getApplicationContext(), "ici : " + viewLike.getText() + memory.url, Toast.LENGTH_SHORT).show();
            viewLink.setVisibility(View.VISIBLE);
            viewLink.setText("Voir le lien :\n" + memory.url);
...
/////////////////////////////////////////////////////////////////
								...
								builder.setItems(items, new DialogInterface.OnClickListener() {
										...
										public void onClick(DialogInterface dialog, int item) {
								               ...
								               switch (item) {
                                                   ...
                                                   {
                                                       Intent intent;
                                                       if (Network.USER != null && memory.user.id == Network.USER.id)
                                                           intent = new Intent(ViewMemory.this, EditInfoUser.class);
                                                       else
                                                           intent = new Intent(ViewMemory.this, ViewInfoUser.class);
                                                       Bundle b = new Bundle();
                                                       b.putInt("userId", listComm.list[position].user.id);
                                                       intent.putExtras(b);
                                                       startActivity(intent);
		    	...
		    	case UPDATE_IMG_MEMORY:
			    	...
			    	{		
                        ...
                        imgMemoryImg.setVisibility(View.VISIBLE);
